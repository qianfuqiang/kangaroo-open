    ...
    <div class="row">
                       	...
                       	<c:forEach items="${lists.content}" var="node">
							<tr>
								...
								<td>
								   ...
								   <a href="${ctx}/admin/course/type/delete/${node.id}.do">删除</a>
							   </td>
							</tr>
						</c:forEach>
		...
		<div id="categoryModal" class="modal hide fade" tabindex="-1" role="dialog" aria-labelledby="myModalLabel" aria-hidden="true">
		  ...
		  <div class="modal-body">
		       <form class="form-horizontal" id="categoryForm" action="${ctx}/admin/course/type/save.do" method="post" >
	...
	<script type="text/javascript">
		...
		function operatingForm(action,id,name){
			if("add"==action){
				...
				$.ajax({
				    type: 'GET',                     
				    url: '${ctx}/admin/course/type/get/'+id+'.do',
				    cache: false,
				    dataType:'json',
